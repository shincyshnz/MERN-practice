        ...
        <Fragment>
            <form className='form-one' onSubmit={handleSubmit}>
                ...
                <div className='fields'>
                    ...
                    <input type='text' id='firstName' name ='firstName' placeholder='First Name' onBlur={handleChange} required/>
                </div>
                ...
                <div className='fields'>
                    ...
                    <input type='email' id='email' name='email' placeholder='Email' onBlur={handleChange} required/>
                </div>
                ...
                <div className='fields'>
                    ...
                    <input type='radio' id='male' name='gender' onBlur={handleChange} defaultValue={"male"} required/>
                
                    <label htmlFor='female'>Female</label>
                    <input type='radio' id='female' name='gender' value={"female"} onBlur={handleChange} required/>
                    </div>
                </div>
                        ...
                        {courses.map((item,index)=>{
                            return (
                                <div className='courseItem' key={item.id}>
                                    ...
                                    <input type='checkbox' id={item.id} name={item.course} value={item.course} onBlur={()=>HandleChangeCheckbox(index)} required/>
                                </div>
                            );
                        })}
                    </div>
                ...
                <div className='fields'>
                    ...
                    <input type='date' id='dob' name='date' onBlur={handleChange} required/>
                </div>
                ...
                <div className='fields'>
                    ...
                    <div>
                        <select name='country' onBlur={handleChange} required>
